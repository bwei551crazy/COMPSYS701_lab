...
module Nios_System_2A_mm_interconnect_0 (
	...
	wire   [13:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> BUTTON_pio_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> Switches_s1_agent:cp_data
	...
	wire   [27:0] hex0_s1_agent_m0_address;                                                  // Hex0_s1_agent:m0_address -> Hex0_s1_translator:uav_address
	...
	wire  [106:0] hex0_s1_agent_rf_source_data;                                              // Hex0_s1_agent:rf_source_data -> Hex0_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] hex0_s1_agent_rsp_fifo_out_data;                                           // Hex0_s1_agent_rsp_fifo:out_data -> Hex0_s1_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> Hex0_s1_agent:cp_data
	...
	wire   [27:0] hex1_s1_agent_m0_address;                                                  // Hex1_s1_agent:m0_address -> Hex1_s1_translator:uav_address
	...
	wire  [106:0] hex1_s1_agent_rf_source_data;                                              // Hex1_s1_agent:rf_source_data -> Hex1_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] hex1_s1_agent_rsp_fifo_out_data;                                           // Hex1_s1_agent_rsp_fifo:out_data -> Hex1_s1_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> Hex1_s1_agent:cp_data
	...
	wire   [27:0] hex2_s1_agent_m0_address;                                                  // Hex2_s1_agent:m0_address -> Hex2_s1_translator:uav_address
	...
	wire  [106:0] hex2_s1_agent_rf_source_data;                                              // Hex2_s1_agent:rf_source_data -> Hex2_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] hex2_s1_agent_rsp_fifo_out_data;                                           // Hex2_s1_agent_rsp_fifo:out_data -> Hex2_s1_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> Hex2_s1_agent:cp_data
	...
	wire   [27:0] hex3_s1_agent_m0_address;                                                  // Hex3_s1_agent:m0_address -> Hex3_s1_translator:uav_address
	...
	wire  [106:0] hex3_s1_agent_rf_source_data;                                              // Hex3_s1_agent:rf_source_data -> Hex3_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] hex3_s1_agent_rsp_fifo_out_data;                                           // Hex3_s1_agent_rsp_fifo:out_data -> Hex3_s1_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> Hex3_s1_agent:cp_data
	...
	wire   [27:0] hex4_s1_agent_m0_address;                                                  // Hex4_s1_agent:m0_address -> Hex4_s1_translator:uav_address
	...
	wire  [106:0] hex4_s1_agent_rf_source_data;                                              // Hex4_s1_agent:rf_source_data -> Hex4_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] hex4_s1_agent_rsp_fifo_out_data;                                           // Hex4_s1_agent_rsp_fifo:out_data -> Hex4_s1_agent:rf_sink_data
	...
	wire          cmd_mux_012_src_valid;                                                     // cmd_mux_012:src_valid -> Hex4_s1_agent:cp_valid
	wire  [105:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> Hex4_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                     // Hex4_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [13:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> Hex4_s1_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                             // cmd_mux_012:src_startofpacket -> Hex4_s1_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                               // cmd_mux_012:src_endofpacket -> Hex4_s1_agent:cp_endofpacket
	...
	wire   [27:0] hex5_s1_agent_m0_address;                                                  // Hex5_s1_agent:m0_address -> Hex5_s1_translator:uav_address
	...
	wire  [106:0] hex5_s1_agent_rf_source_data;                                              // Hex5_s1_agent:rf_source_data -> Hex5_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] hex5_s1_agent_rsp_fifo_out_data;                                           // Hex5_s1_agent_rsp_fifo:out_data -> Hex5_s1_agent:rf_sink_data
	...
	wire          cmd_mux_013_src_valid;                                                     // cmd_mux_013:src_valid -> Hex5_s1_agent:cp_valid
	wire  [105:0] cmd_mux_013_src_data;                                                      // cmd_mux_013:src_data -> Hex5_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                     // Hex5_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [13:0] cmd_mux_013_src_channel;                                                   // cmd_mux_013:src_channel -> Hex5_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                             // cmd_mux_013:src_startofpacket -> Hex5_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                               // cmd_mux_013:src_endofpacket -> Hex5_s1_agent:cp_endofpacket
	...
	wire  [105:0] switches_s1_agent_rp_data;                                                 // Switches_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [105:0] hex0_s1_agent_rp_data;                                                     // Hex0_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [105:0] hex1_s1_agent_rp_data;                                                     // Hex1_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [105:0] hex2_s1_agent_rp_data;                                                     // Hex2_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [105:0] hex3_s1_agent_rp_data;                                                     // Hex3_s1_agent:rp_data -> router_013:sink_data
	...
	wire          hex4_s1_agent_rp_valid;                                                    // Hex4_s1_agent:rp_valid -> router_014:sink_valid
	wire  [105:0] hex4_s1_agent_rp_data;                                                     // Hex4_s1_agent:rp_data -> router_014:sink_data
	wire          hex4_s1_agent_rp_ready;                                                    // router_014:sink_ready -> Hex4_s1_agent:rp_ready
	wire          hex4_s1_agent_rp_startofpacket;                                            // Hex4_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          hex4_s1_agent_rp_endofpacket;                                              // Hex4_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire          hex5_s1_agent_rp_valid;                                                    // Hex5_s1_agent:rp_valid -> router_015:sink_valid
	wire  [105:0] hex5_s1_agent_rp_data;                                                     // Hex5_s1_agent:rp_data -> router_015:sink_data
	wire          hex5_s1_agent_rp_ready;                                                    // router_015:sink_ready -> Hex5_s1_agent:rp_ready
	wire          hex5_s1_agent_rp_startofpacket;                                            // Hex5_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          hex5_s1_agent_rp_endofpacket;                                              // Hex5_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          hex4_s1_agent_rdata_fifo_src_valid;                                        // Hex4_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire   [33:0] hex4_s1_agent_rdata_fifo_src_data;                                         // Hex4_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire          hex4_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_012:in_0_ready -> Hex4_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_012_out_0_valid;                                         // avalon_st_adapter_012:out_0_valid -> Hex4_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_012_out_0_data;                                          // avalon_st_adapter_012:out_0_data -> Hex4_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_012_out_0_ready;                                         // Hex4_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire    [0:0] avalon_st_adapter_012_out_0_error;                                         // avalon_st_adapter_012:out_0_error -> Hex4_s1_agent:rdata_fifo_sink_error
	wire          hex5_s1_agent_rdata_fifo_src_valid;                                        // Hex5_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] hex5_s1_agent_rdata_fifo_src_data;                                         // Hex5_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          hex5_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_013:in_0_ready -> Hex5_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                         // avalon_st_adapter_013:out_0_valid -> Hex5_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                          // avalon_st_adapter_013:out_0_data -> Hex5_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                         // Hex5_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                         // avalon_st_adapter_013:out_0_error -> Hex5_s1_agent:rdata_fifo_sink_error
