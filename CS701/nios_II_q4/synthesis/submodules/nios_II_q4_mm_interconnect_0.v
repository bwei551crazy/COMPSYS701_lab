// nios_II_q4_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module nios_II_q4_mm_interconnect_0 (
		...
		output wire [1:0]  recv_s1_address,                           //                         recv_s1.address
		input  wire [31:0] recv_s1_readdata,                          //                                .readdata
		output wire [1:0]  send_s1_address,                           //                         send_s1.address
		output wire        send_s1_write,                             //                                .write
		input  wire [31:0] send_s1_readdata,                          //                                .readdata
		output wire [31:0] send_s1_writedata,                         //                                .writedata
		output wire        send_s1_chipselect,                        //                                .chipselect
	...
	wire  [94:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> timer_s1_agent:cp_data
	...
	wire  [95:0] key_s1_agent_rf_source_data;                                               // key_s1_agent:rf_source_data -> key_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] key_s1_agent_rsp_fifo_out_data;                                            // key_s1_agent_rsp_fifo:out_data -> key_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> key_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // key_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire  [13:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> key_s1_agent:cp_channel
	...
	wire  [31:0] send_s1_agent_m0_readdata;                                                 // send_s1_translator:uav_readdata -> send_s1_agent:m0_readdata
	wire         send_s1_agent_m0_waitrequest;                                              // send_s1_translator:uav_waitrequest -> send_s1_agent:m0_waitrequest
	wire         send_s1_agent_m0_debugaccess;                                              // send_s1_agent:m0_debugaccess -> send_s1_translator:uav_debugaccess
	wire  [16:0] send_s1_agent_m0_address;                                                  // send_s1_agent:m0_address -> send_s1_translator:uav_address
	wire   [3:0] send_s1_agent_m0_byteenable;                                               // send_s1_agent:m0_byteenable -> send_s1_translator:uav_byteenable
	wire         send_s1_agent_m0_read;                                                     // send_s1_agent:m0_read -> send_s1_translator:uav_read
	wire         send_s1_agent_m0_readdatavalid;                                            // send_s1_translator:uav_readdatavalid -> send_s1_agent:m0_readdatavalid
	wire         send_s1_agent_m0_lock;                                                     // send_s1_agent:m0_lock -> send_s1_translator:uav_lock
	wire  [31:0] send_s1_agent_m0_writedata;                                                // send_s1_agent:m0_writedata -> send_s1_translator:uav_writedata
	wire         send_s1_agent_m0_write;                                                    // send_s1_agent:m0_write -> send_s1_translator:uav_write
	wire   [2:0] send_s1_agent_m0_burstcount;                                               // send_s1_agent:m0_burstcount -> send_s1_translator:uav_burstcount
	wire         send_s1_agent_rf_source_valid;                                             // send_s1_agent:rf_source_valid -> send_s1_agent_rsp_fifo:in_valid
	wire  [95:0] send_s1_agent_rf_source_data;                                              // send_s1_agent:rf_source_data -> send_s1_agent_rsp_fifo:in_data
	wire         send_s1_agent_rf_source_ready;                                             // send_s1_agent_rsp_fifo:in_ready -> send_s1_agent:rf_source_ready
	wire         send_s1_agent_rf_source_startofpacket;                                     // send_s1_agent:rf_source_startofpacket -> send_s1_agent_rsp_fifo:in_startofpacket
	wire         send_s1_agent_rf_source_endofpacket;                                       // send_s1_agent:rf_source_endofpacket -> send_s1_agent_rsp_fifo:in_endofpacket
	wire         send_s1_agent_rsp_fifo_out_valid;                                          // send_s1_agent_rsp_fifo:out_valid -> send_s1_agent:rf_sink_valid
	wire  [95:0] send_s1_agent_rsp_fifo_out_data;                                           // send_s1_agent_rsp_fifo:out_data -> send_s1_agent:rf_sink_data
	wire         send_s1_agent_rsp_fifo_out_ready;                                          // send_s1_agent:rf_sink_ready -> send_s1_agent_rsp_fifo:out_ready
	wire         send_s1_agent_rsp_fifo_out_startofpacket;                                  // send_s1_agent_rsp_fifo:out_startofpacket -> send_s1_agent:rf_sink_startofpacket
	wire         send_s1_agent_rsp_fifo_out_endofpacket;                                    // send_s1_agent_rsp_fifo:out_endofpacket -> send_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> send_s1_agent:cp_valid
	wire  [94:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> send_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // send_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [13:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> send_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> send_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> send_s1_agent:cp_endofpacket
	wire  [31:0] recv_s1_agent_m0_readdata;                                                 // recv_s1_translator:uav_readdata -> recv_s1_agent:m0_readdata
	wire         recv_s1_agent_m0_waitrequest;                                              // recv_s1_translator:uav_waitrequest -> recv_s1_agent:m0_waitrequest
	wire         recv_s1_agent_m0_debugaccess;                                              // recv_s1_agent:m0_debugaccess -> recv_s1_translator:uav_debugaccess
	wire  [16:0] recv_s1_agent_m0_address;                                                  // recv_s1_agent:m0_address -> recv_s1_translator:uav_address
	wire   [3:0] recv_s1_agent_m0_byteenable;                                               // recv_s1_agent:m0_byteenable -> recv_s1_translator:uav_byteenable
	wire         recv_s1_agent_m0_read;                                                     // recv_s1_agent:m0_read -> recv_s1_translator:uav_read
	wire         recv_s1_agent_m0_readdatavalid;                                            // recv_s1_translator:uav_readdatavalid -> recv_s1_agent:m0_readdatavalid
	wire         recv_s1_agent_m0_lock;                                                     // recv_s1_agent:m0_lock -> recv_s1_translator:uav_lock
	wire  [31:0] recv_s1_agent_m0_writedata;                                                // recv_s1_agent:m0_writedata -> recv_s1_translator:uav_writedata
	wire         recv_s1_agent_m0_write;                                                    // recv_s1_agent:m0_write -> recv_s1_translator:uav_write
	wire   [2:0] recv_s1_agent_m0_burstcount;                                               // recv_s1_agent:m0_burstcount -> recv_s1_translator:uav_burstcount
	wire         recv_s1_agent_rf_source_valid;                                             // recv_s1_agent:rf_source_valid -> recv_s1_agent_rsp_fifo:in_valid
	wire  [95:0] recv_s1_agent_rf_source_data;                                              // recv_s1_agent:rf_source_data -> recv_s1_agent_rsp_fifo:in_data
	wire         recv_s1_agent_rf_source_ready;                                             // recv_s1_agent_rsp_fifo:in_ready -> recv_s1_agent:rf_source_ready
	wire         recv_s1_agent_rf_source_startofpacket;                                     // recv_s1_agent:rf_source_startofpacket -> recv_s1_agent_rsp_fifo:in_startofpacket
	wire         recv_s1_agent_rf_source_endofpacket;                                       // recv_s1_agent:rf_source_endofpacket -> recv_s1_agent_rsp_fifo:in_endofpacket
	wire         recv_s1_agent_rsp_fifo_out_valid;                                          // recv_s1_agent_rsp_fifo:out_valid -> recv_s1_agent:rf_sink_valid
	wire  [95:0] recv_s1_agent_rsp_fifo_out_data;                                           // recv_s1_agent_rsp_fifo:out_data -> recv_s1_agent:rf_sink_data
	wire         recv_s1_agent_rsp_fifo_out_ready;                                          // recv_s1_agent:rf_sink_ready -> recv_s1_agent_rsp_fifo:out_ready
	wire         recv_s1_agent_rsp_fifo_out_startofpacket;                                  // recv_s1_agent_rsp_fifo:out_startofpacket -> recv_s1_agent:rf_sink_startofpacket
	wire         recv_s1_agent_rsp_fifo_out_endofpacket;                                    // recv_s1_agent_rsp_fifo:out_endofpacket -> recv_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> recv_s1_agent:cp_valid
	wire  [94:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> recv_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // recv_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire  [13:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> recv_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> recv_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> recv_s1_agent:cp_endofpacket
	...
	wire  [16:0] addr_s1_agent_m0_address;                                                  // addr_s1_agent:m0_address -> addr_s1_translator:uav_address
	...
	wire  [95:0] addr_s1_agent_rf_source_data;                                              // addr_s1_agent:rf_source_data -> addr_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] addr_s1_agent_rsp_fifo_out_data;                                           // addr_s1_agent_rsp_fifo:out_data -> addr_s1_agent:rf_sink_data
	...
	wire         cmd_mux_013_src_valid;                                                     // cmd_mux_013:src_valid -> addr_s1_agent:cp_valid
	wire  [94:0] cmd_mux_013_src_data;                                                      // cmd_mux_013:src_data -> addr_s1_agent:cp_data
	wire         cmd_mux_013_src_ready;                                                     // addr_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire  [13:0] cmd_mux_013_src_channel;                                                   // cmd_mux_013:src_channel -> addr_s1_agent:cp_channel
	wire         cmd_mux_013_src_startofpacket;                                             // cmd_mux_013:src_startofpacket -> addr_s1_agent:cp_startofpacket
	wire         cmd_mux_013_src_endofpacket;                                               // cmd_mux_013:src_endofpacket -> addr_s1_agent:cp_endofpacket
	...
	wire  [94:0] timer_s1_agent_rp_data;                                                    // timer_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [94:0] key_s1_agent_rp_data;                                                      // key_s1_agent:rp_data -> router_006:sink_data
	...
	wire         send_s1_agent_rp_valid;                                                    // send_s1_agent:rp_valid -> router_007:sink_valid
	wire  [94:0] send_s1_agent_rp_data;                                                     // send_s1_agent:rp_data -> router_007:sink_data
	wire         send_s1_agent_rp_ready;                                                    // router_007:sink_ready -> send_s1_agent:rp_ready
	wire         send_s1_agent_rp_startofpacket;                                            // send_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         send_s1_agent_rp_endofpacket;                                              // send_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         recv_s1_agent_rp_valid;                                                    // recv_s1_agent:rp_valid -> router_008:sink_valid
	wire  [94:0] recv_s1_agent_rp_data;                                                     // recv_s1_agent:rp_data -> router_008:sink_data
	wire         recv_s1_agent_rp_ready;                                                    // router_008:sink_ready -> recv_s1_agent:rp_ready
	wire         recv_s1_agent_rp_startofpacket;                                            // recv_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         recv_s1_agent_rp_endofpacket;                                              // recv_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         addr_s1_agent_rp_valid;                                                    // addr_s1_agent:rp_valid -> router_015:sink_valid
	wire  [94:0] addr_s1_agent_rp_data;                                                     // addr_s1_agent:rp_data -> router_015:sink_data
	wire         addr_s1_agent_rp_ready;                                                    // router_015:sink_ready -> addr_s1_agent:rp_ready
	wire         addr_s1_agent_rp_startofpacket;                                            // addr_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire         addr_s1_agent_rp_endofpacket;                                              // addr_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire         send_s1_agent_rdata_fifo_src_valid;                                        // send_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] send_s1_agent_rdata_fifo_src_data;                                         // send_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         send_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_005:in_0_ready -> send_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> send_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> send_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                         // send_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> send_s1_agent:rdata_fifo_sink_error
	wire         recv_s1_agent_rdata_fifo_src_valid;                                        // recv_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] recv_s1_agent_rdata_fifo_src_data;                                         // recv_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         recv_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_006:in_0_ready -> recv_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> recv_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> recv_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // recv_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> recv_s1_agent:rdata_fifo_sink_error
	...
	wire         addr_s1_agent_rdata_fifo_src_valid;                                        // addr_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire  [33:0] addr_s1_agent_rdata_fifo_src_data;                                         // addr_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire         addr_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_013:in_0_ready -> addr_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_013_out_0_valid;                                         // avalon_st_adapter_013:out_0_valid -> addr_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_013_out_0_data;                                          // avalon_st_adapter_013:out_0_data -> addr_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_013_out_0_ready;                                         // addr_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire   [0:0] avalon_st_adapter_013_out_0_error;                                         // avalon_st_adapter_013:out_0_error -> addr_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (send_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (send_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (send_s1_agent_m0_read),                 //                         .read
		.uav_write              (send_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (send_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (send_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (send_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (send_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (send_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (send_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (send_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (send_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (send_s1_write),                         //                         .write
		.av_readdata            (send_s1_readdata),                      //                         .readdata
		.av_writedata           (send_s1_writedata),                     //                         .writedata
		.av_chipselect          (send_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (recv_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (recv_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (recv_s1_agent_m0_read),                 //                         .read
		.uav_write              (recv_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (recv_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (recv_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (recv_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (recv_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (recv_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (recv_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (recv_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (recv_s1_address),                       //      avalon_anti_slave_0.address
		.av_readdata            (recv_s1_readdata),                      //                         .readdata
		.av_write               (),                                      //              (terminated)
		.av_read                (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                            //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (send_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (send_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (send_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (send_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (send_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (send_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (send_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (send_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (send_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (send_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (send_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (send_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (send_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (send_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (send_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (send_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (send_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (send_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (send_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (send_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (send_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (send_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (send_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (send_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (send_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (send_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),        //                .error
		.rdata_fifo_src_ready    (send_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (send_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (send_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) send_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                            //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (send_s1_agent_rf_source_data),             //        in.data
		.in_valid          (send_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (send_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (send_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (send_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (send_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (send_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (send_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (send_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (send_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                            //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (recv_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (recv_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (recv_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (recv_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (recv_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (recv_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (recv_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (recv_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (recv_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (recv_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (recv_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (recv_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (recv_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (recv_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (recv_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (recv_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (recv_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (recv_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (recv_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (recv_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (recv_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (recv_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (recv_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (recv_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (recv_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (recv_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),        //                .error
		.rdata_fifo_src_ready    (recv_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (recv_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (recv_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) recv_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                            //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (recv_s1_agent_rf_source_data),             //        in.data
		.in_valid          (recv_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (recv_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (recv_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (recv_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (recv_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (recv_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (recv_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (recv_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (recv_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	nios_II_q4_mm_interconnect_0_router router (
	...
	nios_II_q4_mm_interconnect_0_router_001 router_001 (
	...
	nios_II_q4_mm_interconnect_0_router_002 router_002 (
	...
	nios_II_q4_mm_interconnect_0_router_003 router_003 (
	...
	nios_II_q4_mm_interconnect_0_router_002 router_004 (
	...
	nios_II_q4_mm_interconnect_0_router_003 router_005 (
	...
	nios_II_q4_mm_interconnect_0_router_002 router_006 (
	...
	nios_II_q4_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (send_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (send_s1_agent_rp_valid),                //          .valid
		.sink_data          (send_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (send_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (send_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (recv_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (recv_s1_agent_rp_valid),                //          .valid
		.sink_data          (recv_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (recv_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (recv_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_router_002 router_009 (
	...
	nios_II_q4_mm_interconnect_0_router_002 router_010 (
	...
	nios_II_q4_mm_interconnect_0_router_002 router_011 (
	...
	nios_II_q4_mm_interconnect_0_router_002 router_012 (
	...
	nios_II_q4_mm_interconnect_0_router_002 router_013 (
	...
	nios_II_q4_mm_interconnect_0_router_002 router_014 (
	...
	nios_II_q4_mm_interconnect_0_router_002 router_015 (
	...
	nios_II_q4_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                 (clk_0_clk_clk),                                 //        clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                        //        clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_010 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_011 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_012 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_cmd_mux cmd_mux_013 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_010 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_011 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_012 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_demux rsp_demux_013 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                  (clk_0_clk_clk),                         //       clk.clk
		.reset                (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_II_q4_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	nios_II_q4_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (CPU_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (send_s1_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (send_s1_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (send_s1_agent_rdata_fifo_src_ready),    //         .ready
	...
	nios_II_q4_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (CPU_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (recv_s1_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (recv_s1_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (recv_s1_agent_rdata_fifo_src_ready),    //         .ready
